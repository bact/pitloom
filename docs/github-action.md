...
Pin to a specific release tag (`@v0.16.1`) rather than a branch, the same
...
| `pitloom-version` | *(empty)* | Pitloom version/specifier to install, e.g. `0.16.1` or `>=0.13,<1.0`. Empty installs the latest release. |
