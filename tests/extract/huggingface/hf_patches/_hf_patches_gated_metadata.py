...
"""Mock patches for models whose config, tokenizer config, and model card are
all fetchable, but the card carries no ``pipeline_tag``.

See also: _hf_patches_base.py, _hf_patches_gated_access.py,
