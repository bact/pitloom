...
sibling ``test_huggingface_*.py`` modules live in the topic-grouped
``_hf_patches_*`` submodules and are re-exported here.
...
from ._hf_patches_embeddings import (
...
from ._hf_patches_gated_metadata import (
...
from ._hf_patches_generative_3d import (
...
from ._hf_patches_multimodal import (
...
from ._hf_patches_omni_modal import (
    _AION_CARD_DATA,
    _AION_CONFIG,
    _BAGEL_CARD_DATA,
    _BAGEL_CONFIG,
...
from ._hf_patches_speech_audio import (
...
from ._hf_patches_structured_text import (
    _MOIRAI_CARD_DATA,
    _MOIRAI_CONFIG,
    _SAP_RPT_CARD_DATA,
    _SUGOI_CARD_DATA,
...
from ._hf_patches_text_generation_instruct import (
...
from ._hf_patches_text_generation_pretrained import (
    _BLOOM_CARD_DATA,
    _BLOOM_CONFIG,
    _LLAMA_CARD_DATA,
...
from ._hf_patches_text_generation_regional import (
    _CHINDA_CARD_DATA,
    _CHINDA_CONFIG,
...
from ._hf_patches_vision import (
