...
"""Tests for read_pyproject()'s license-classifier-conflict recovery and
its license-hint-resolution private helpers. Split out of test_pyproject.py
to keep that file under this repo's file-size soft limit.

See also: test_pyproject.py for the rest of read_pyproject()'s
[project]-focused parsing paths; test_pyproject_dynamic.py for PEP 621
``dynamic`` field resolution; test_poetry_pyproject.py for the
[tool.poetry] fallback/override behaviour.
"""
