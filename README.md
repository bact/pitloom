...
```toml
[build-system]
requires = ["hatchling>=1.32.0", "pitloom>=0.16.0"]
...
> Suriyawongkul, A. (2026). Pitloom - SBOM generator for AI models and Python projects (Version 0.16.0) [Computer software]. https://doi.org/10.5281/zenodo.19246283
